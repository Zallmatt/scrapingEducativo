...
class ReadDataExcelTasaPromocionEfectiva:
    def load_route_excel(self, name):
        file_path = os.path.join(os.path.dirname(__file__), "../files", name)
        print(f"📄 Cargando archivo: {file_path}")
        return file_path

    def create_df_promocion_efectiva(self):
        name = "Tasa de Promoción Efectiva 2022-2012 según división político-territorial.xlsx"
        ...
        for hoja in hojas:
            ...
            try:
                ...
                df_clean["Prom_Estructura_Educativa"] = df[1]
                df_clean["Prom_Total_Primaria"] = df[2]
                df_clean["Prom_Año1_P"] = df[3]
                df_clean["Prom_Año2_P"] = df[4]
                df_clean["Prom_Año3_P"] = df[5]
                df_clean["Prom_Año4_P"] = df[6]
                df_clean["Prom_Año5_P"] = df[7]
                df_clean["Prom_Año6_P"] = df[8]
                df_clean["Prom_Año7_P"] = df[9]

                df_clean["Prom_Total_Secundaria"] = df[10]
                df_clean["Prom_Año7_S"] = df[11]
                df_clean["Prom_Año8_S"] = df[12]
                df_clean["Prom_Año9_S"] = df[13]
                df_clean["Prom_Año10_S"] = df[14]
                df_clean["Prom_Año11_S"] = df[15]
                df_clean["Prom_Año12_S"] = df[16]
